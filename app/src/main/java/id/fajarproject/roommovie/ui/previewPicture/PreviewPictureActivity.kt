...
class PreviewPictureActivity : AppCompatActivity(),PreviewPictureContract.View {
        ...
        override fun onMapSharedElements(names: MutableList<String>, sharedElements: MutableMap<String?, View?>) {
            if (isReturning) {
                ...
                if (startingPosition != currentPosition) {
                    names.clear()
                    names.add(sharedElement?.let { ViewCompat.getTransitionName(it) } ?: getString(R.string.transition_title,currentPosition))

                    sharedElements.clear()
                    sharedElements[sharedElement?.let { ViewCompat.getTransitionName(it) }] = sharedElement
                }
            }
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        currentPosition = savedInstanceState?.getInt(Constant.SAVED_CURRENT_PAGE_POSITION) ?: startingPosition
    ...
    override fun setToolbar() {
        ...
        Util.setColorFilter(toolbar.navigationIcon!!, ContextCompat.getColor(this,R.color.colorWhite))
    ...
    override fun setViewPager() {
        ...
        viewPager.adapter = imagePagerAdapterPreview
